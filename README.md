...
Here is the front end repo [link](https://github.com/Estherstarr/front-end.git)  that displays data that is fetched in the front end.
...
```sh
  git clone https://github.com/Estherstarr/hello-rails-backend.git
